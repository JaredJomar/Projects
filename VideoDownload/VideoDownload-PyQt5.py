...
class MainWindow(QMainWindow):
    ...
    def create_main_tab(self):
        ...
        self.url_input.setStyleSheet("QLineEdit { background-color: #fff; color: #000; font-weight: bold; }")
        ...
        self.download_folder_input.setStyleSheet("QLineEdit { background-color: #fff; color: #000; font-weight: bold; }")
        ...
        self.progress_text.setStyleSheet("QTextEdit { background-color: #06283D; color: green; font-weight: bold; }")
    ...
    def create_settings_tab(self):
        ...
        self.ffmpeg_input.setStyleSheet("QLineEdit { background-color: #fff; color: #000; font-weight: bold; }")
        ...
        ffmpeg_browse_button.setStyleSheet("QPushButton { background-color: #06283D; color: white; font-weight: bold; }")
        ...
        self.yt_dlp_input.setStyleSheet("QLineEdit { background-color: #fff; color: #000    ; font-weight: bold; }")
        ...
        ytdlp_browse_button.setStyleSheet("QPushButton { background-color: #06283D; color: white; font-weight: bold; }")
